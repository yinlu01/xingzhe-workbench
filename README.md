...
> 个人生活与学习工作台 —— 读书、运动、人脉、待办、复盘，一个界面全搞定。
...
| 💪 运动 | 运动计划 | 周训练计划（推日/拉日/腿日/搏击操/核心/有氧吊杠）、每日打卡、训练历史 |
...
- **前端**：单文件 `mac-dashboard.html`（约 3000 行，HTML + CSS + JS 内联），无任何前端框架、无构建步骤、无外部 CDN 依赖，离线可用。
